    ...
    <div className="parallax aboutme-parallex">
      ...
      >
        ...
        <p className="aboutpara">
          ...
          Development from Northwestern University, where I developed skills in
          JavaScript, React.js, Node.js, Axios, Express, MongoDB, SQL, CSS,
          ...
          <Col m={6} s={12}>
            <Card
              ...
              reveal={
                <>
                  <p>
                    App that provides recipes to users with ingredients the
                    users have on hand. Built with Spoonacular API, MySQL,
                    Passport, Bulma,Express, Express Handlebars, ESLint. Travis.
                    <br />
                    <br />
                  </p>
                  <div className="cardLinks">
